...
func TestExample(t *testing.T) {
	...
	o, err := exec.Command("go", "build", "-o", exepath, "github.com/getlantern/winsvc/example").CombinedOutput()
	if err != nil {
	...
	// testing deadlock from https://github.com/getlantern/winsvc/issues/detail?id=4
